    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-400 font-bold text-sm">Loading landlord dashboard...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-3">
            <NextLink href="/dashboard/landlord/properties/new">
              <Button className="bg-slate-900 hover:bg-slate-800 text-white font-bold cursor-pointer rounded-xl px-4 py-2.5 text-xs flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
          <div className="bg-white p-6 rounded-3xl border border-slate-100/80 shadow-[0_4px_20px_rgba(0,0,0,0.01)] flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-black text-slate-800 leading-none">{totalProperties}</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100/80 shadow-[0_4px_20px_rgba(0,0,0,0.01)] flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-black text-slate-800 leading-none">{pendingRequestsCount}</p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-50">
                  {properties.map((prop) => (
                    <tr key={prop.id} className="text-slate-600 text-xs font-semibold group hover:bg-slate-50/50">
                      <td className="py-4 pl-2 font-bold text-slate-800 text-sm group-hover:text-primary transition-colors">
                        {prop.title}
                      </td>
                      <td className="py-4 text-slate-500">{prop.location}</td>
                      <td className="py-4 font-extrabold text-slate-800">৳{prop.price.toLocaleString()}</td>
                      <td className="py-4">
                      ...
                      <td className="py-4 pr-2 text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <button
                            ...
                            disabled={isPending}
                            className="p-1.5 text-red-400 hover:text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors cursor-pointer"
