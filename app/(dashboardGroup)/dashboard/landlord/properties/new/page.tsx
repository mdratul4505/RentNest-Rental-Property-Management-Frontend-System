...
import { getCategories } from "@/service/properties";
import { createLandlordProperty } from "@/service/landlord";
...
export default function NewPropertyPage() {
  ...
  const onSubmit = (data: PropertyFormValues) => {
    // Process comma-separated amenities into array of strings
      ...
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.015)] border border-slate-100 relative z-10 animate-fade-in-up">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
            <Building2 className="w-6 h-6 text-primary" /> List a New Property
          </h2>
          <p className="text-slate-400 text-xs font-semibold mt-1">
            Provide the details of your property to make it available for tenants
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Cozy 2 Bedroom Apartment in Banani"
            />
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Provide a detailed description of the property, surrounding area, building rules..."
            />
            {errors.description && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. WiFi, AC, Parking, Lift, Generator"
                />
              </div>
              {errors.amenities && (
          ...
          <div className="pt-4 flex items-center gap-4">
            ...
            >
              {isPending ? (
                <>
                  <Loader2 className="w-4.5 h-4.5 animate-spin" /> Listing Property...
                </>
              ) : (
                <>
                  <CheckCircle2 className="w-4.5 h-4.5" /> Post Listing
                </>
              )}
            </Button>
